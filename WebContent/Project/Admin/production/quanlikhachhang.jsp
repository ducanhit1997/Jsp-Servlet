...
<body class="nav-md">
	<div class="container body">
							...
							<div class="x_panel">
								...
								<div class="x_content">
									<table id="datatable-buttons" class="table table-striped table-bordered">
										...
										<tbody>
											<%
												ArrayList<KhachHang> kh = KhachHangDao.getList();
												int count = 0;
											...
											<tr>
												<td><%=count%></td>
												<td><%=kh.get(i).getMaTaiKhoan()%></td>
												<td><%=kh.get(i).getTenDangNhap()%></td>
												<td><%=kh.get(i).getEmail()%></td>
												<td><%=kh.get(i).getGioiTinh()%></td>
												<td><a
													href="#"
													class="btn btn-success xem" data-toggle="modal" data-target="#Xem<%=kh.get(i).getMaTaiKhoan()%>" title="Xem chi tiết"
													id="xem-' + t.maNhanVien + '"><i class="fa fa-search"></i></a>

													<a href="#"
													class="btn btn-success sua" data-toggle="modal" data-target="#Sua<%=kh.get(i).getMaTaiKhoan()%>" title="Chỉnh sửa thông tin "
													id="sua-' + t.maNhanVien + '"><i class="fa fa-retweet"
														aria-hidden="true"></i></a> <a class="btn btn-danger xoa"
													data-toggle="modal" data-target="#Xoa<%=kh.get(i).getMaTaiKhoan()%>"
		...
		<div id="Xoa<%=kh.get(i).getMaTaiKhoan()%>" class="modal fade"
			role="dialog">
			<div class="modal-dialog">
				...
				<div class="modal-content">
					...
					<div class="modal-body" style="text-align: center;">
						Bạn có chắc chắn xóa khách hàng <%out.print(kh.get(i).getTenDangNhap()); %>?
					</div>
					<div class="modal-footer">
						<a href="<%=request.getContextPath()%>/KhachHangController?action=xoa&mataikhoan=<%=kh.get(i).getMaTaiKhoan()%>">
		...
		<div id="Xem<%=kh.get(i).getMaTaiKhoan()%>" class="modal fade"
			role="dialog">
			<div class="modal-dialog">
				...
				<div class="modal-content">
					...
					<div class="modal-body" style="margin-left: 200px;">
						<p>Mã tài khoản: <%out.print(kh.get(i).getMaTaiKhoan());%></p>
						<p>Tên khách hàng: <%out.print(kh.get(i).getTenDangNhap());%> </p>
						<p>Email: <%out.print(kh.get(i).getEmail());%></p>
						<p>Mật khẩu: ******</p>
						<p>Giới tính: <%out.print(kh.get(i).getGioiTinh());%></p>
		...
		<div id="Sua<%=kh.get(i).getMaTaiKhoan()%>" class="modal fade"
			role="dialog">
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<form class="form-horizontal"
											...
											<div class="form-group">
												<label class="control-label col-sm-4" for="pwd">Mã khách hàng:</label>
												<div class="col-sm-4">
											
													<input type="text" class="form-control" id="tenkhachhang"
														name="makhachhang" value="<%out.print(kh.get(i).getMaTaiKhoan());%>" readonly="readonly">
											...
											<div class="form-group">
												...
												<div class="col-sm-4">
													<input type="text" class="form-control" id="tenkhachhang"
														name="tenkhachhang" value="<%out.print(kh.get(i).getTenDangNhap());%>">
													<p id="error_tenkhachhang" style="color: red;"></p>
												</div>
											</div>
											<div class="form-group">
												...
												<div class="col-sm-4">
													<input type="text" class="form-control" id="email"
														placeholder="Nhập email" name="email" value="<%out.print(kh.get(i).getEmail());%>">
													<p id="error_email" style="color: red;"></p>
												</div>
											</div>
											<div class="form-group">
												...
												<div class="col-sm-4">
													<input type="password" class="form-control" id="matkhau"
														placeholder="Nhập mật khẩu" name="matkhau" value="******" readonly="readonly">
											...
											<div class="form-group">
												...
												<div class="col-sm-4">
													<label class="radio-inline"><input type="radio"
														...
														value="Nam" checked="checked">Nam</label> <label class="radio-inline"><input
														type="radio" name="gioitinh" id="gioitinh" value="Nam">Nữ</label>
