			...
			<div class="single-page">
				<div class="single-page-row" id="detail-21">
					<div class="col-md-6 single-top-left">	
					 <%SanPham s=(SanPham) session.getAttribute("ctsp");%>
					  <%SanPhamDao sp=new SanPhamDao();
								ArrayList<SanPham> list=sp.getList();
								%>
								
						<div class="flexslider">
							<ul class="slides">
								<li data-thumb="images/s1.jpg">
									<div class="thumb-image detail_images"> <img src="<%=s.getHinhAnh() %>" data-imagezoom="true" class="img-responsive" alt=""> </div>
								</li>
							</ul>
						</div> 
					</div>
					...
					<div class="col-md-6 single-top-right">
						<h3 class="item_name"> <%=s.getTenTruyen() %></h3>
					...
					<div class="single-price">
							<ul>
								<li>Giá: <%=s.getGia() %>đ</li> 
								<br><li>Tác giả:  <%=TacGiaDao.name(s.getMaTacGia())%></li> 
								<br><li>Số cuốn: <%=s.getSoCuon() %></li> 
								<br><li>Nhà xuất bản: <%=NhaXuatBanDao.name(s.getMaNhaXuatBan())%></li>  
							</ul>	
						</div> 
						
							<a href="<%=request.getContextPath()%>/XuLyMua?masp=<%=s.getMaTruyen()%>"><button class="btn-lg btn-suscess">Thêm vào giỏ hàng</button></a>
				...
				<div class="fb-comments" data-href="http://2018group22.azurewebsites.net" data-numposts="5"></div>
			<!-- <!-- collapse-tabs -->
...
<script>(function(d, s, id) {
  ...
  js.src = 'https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v3.0&appId=346903995840107&autoLogAppEvents=1';
